...
<body>
	...
	<section class="a4-size page-break">
			...
			<tr>
				<td style="border-top:0;" colspan="3">
					<table class="table-borderless" style="width: 100%; margin:0;padding:0;">
						...
						{{-- GENERAL NOTES --}}
						<tr>
							<td class="text-sm text-condensed" colspan="4">
		...
		<table class="table">
			...
			<tr>
				<td class="text-xs text-condensed"  colspan="2">
		...
		<div style="position: absolute; bottom: 0; width: 100%;">
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<td>
						<table class="table-borderless text-xs text-condensed" cellspacing="0" cellpadding="0" >
							<tr>
								<td><b>PROJECT #:</b></td>
								<td><b>20031</b></td>
							</tr>
